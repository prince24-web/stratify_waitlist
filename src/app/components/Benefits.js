...
export default function Benefit() {
  ...
  const features = [
    {
      ...
      description: "From ad creation to email sequences and social media posts, AI automates everything you hours of manual work."
    },
    {
      id: 2,
      title: "Maximize ROI with AI Optimization",
      description: "Smart algorithms continuously optimize your campaigns for better performance and higher returns on investment."
    },
    {
      id: 3,
      title: "Automate Customer Engagement",
      description: "Personalized customer interactions powered by intelligent automation and behavioral triggers for maximum impact."
    }
  ];
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8">
      <div className="w-[70rem] h-[30rem] mx-auto backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 flex items-center justify-between shadow-xl">
        ...
        {/* Right: Content */}
        <div className="w-1/2 text-white space-y-4 pl-6">
          ...
          <h2 className="text-3xl font-bold mb-6">Powerful Features to <br/> Boost Your business</h2>

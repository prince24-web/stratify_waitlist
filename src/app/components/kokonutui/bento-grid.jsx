...
const bentoItems = [
   {
    id: "main",
    title: "Smarter Marketing, Simplified",
    description:
        "Our AI-powered platform helps you craft tailored strategies, generate content, and optimize SEO—so you can grow faster with less effort.",
    href: "#",
    feature: "spotlight",
    spotlightItems: [
    ...
    {
  id: "stat1",
  title: "Metadata Generation & SEO Boost",
  description:
    "Automatically generate SEO-optimized titles, descriptions, and tags to boost visibility and save time.",
  href: "#",
  feature: "typing",
  typingText: `export const metadata = {
  title: "MarketAI – Smart Marketing Strategy Generator",
  description:
    "MarketAI helps you instantly generate tailored marketing strategies, campaigns, and social media content using AI-powered insights.",
  keywords: [
    "AI marketing",
    "strategy generator",
  ...
  openGraph: {
    title: "MarketAI – Smart Marketing Strategy Generator",
    description:
      "Turn your ideas into campaigns with AI-powered marketing plans, SEO optimization, and automated content generation.",
    url: "https://marketai.app",
    siteName: "MarketAI",
    images: [
      {
        url: "https://marketai.app/og-image.png",
        width: 1200,
        height: 630,
        alt: "MarketAI Preview",
      },
    ],
    type: "website",
  },
  twitter: {
    ...
    title: "MarketAI – Smart Marketing Strategy Generator",
    description:
      "Automate your marketing workflow with AI-driven strategies and content generation.",
    images: ["https://marketai.app/og-image.png"],
    creator: "@marketai",
  },
};`,
  size: "md",
...
const glassCard = `
  ...
  hover:border-neutral-400/30 dark:hover:border-neutral-600/30 
...
export default function BentoGrid() {
    return (
        <section
            className="relative py-24 sm:py-32 rounded backdrop-blur-md bg-white dark:bg-black/20 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <motion.div
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <motion.div
                            variants={fadeInUp}
                            className="md:col-span-1 rounded-xl overflow-hidden  backdrop-blur-md dark:bg-black/20 border-neutral-200/50 dark:border-neutral-800/50 hover:border-neutral-400/30 dark:hover:border-neutral-600/30 hover:shadow-lg hover:shadow-neutral-200/20 dark:hover:shadow-neutral-900/20 transition-all duration-300">
                            <div className="p-5">

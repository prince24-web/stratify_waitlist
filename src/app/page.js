...
export default function HomePage() {
  return (
    <main className="relative flex flex-col items-center justify-start min-h-screen text-white overflow-x-hidden">
      ...
      {/* Hero Content */}
      <div className="z-10 text-center max-w-5xl px-4 sm:px-6 md:px-8 pt-20 sm:pt-28 md:pt-32">
        {/* Small badge/label */}
        ...
        {/* Main heading */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-snug sm:leading-tight bg-gradient-to-r from-cyan-100 to-white bg-clip-text text-transparent">
      ...
      <div className="z-10 flex justify-center mt-12 w-full px-4">
        <p className="text-sm sm:text-base md:text-lg text-gray-400 mb-8 max-w-xl mx-auto text-center">
